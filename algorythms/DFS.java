...
public class Solution {
    ...
    private static void cleanPath(Hashtable<String, String> graph, 
        ...
        while (stackCounter < path.size()) {
            ...
            boolean isVisited = finAdditionalNeighbors(graph, visitedNodes, pendingNodes, currentNode, readOnly); 
    ...
    private static boolean finAdditionalNeighbors(Hashtable<String, String> graph, 
                                               Hashtable<String, Boolean> visitedNodes,
                                               Stack<String> pendingNodes,
                                               String currentNode,
                                               boolean readOnly) {
    ...
    private static void DFS(Hashtable<String, String> graph, String fromNode, String toNode) {
        ...
        while (!pendingNodes.empty()) {
            ...
            boolean endOfTheRoad = finAdditionalNeighbors(graph, visitedNodes, pendingNodes, currentNode, readOnly); 
